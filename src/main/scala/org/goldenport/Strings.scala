...
object Strings {
  object mimetype {
    ...
    val application_powerpointx = "application/vnd.openxmlformats-officedocument.officedocument.presentationml.presentation"
    val application_word = "application/vnd.ms-msword"
