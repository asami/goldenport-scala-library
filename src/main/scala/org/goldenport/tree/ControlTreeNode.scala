...
object ControlTreeNode {
  ...
  case class Collection[E](nodes: List[TreeNode[E]]) extends ControlTreeNode[E] {
    ...
    override protected def show_String: String = nodes.map(_.embed).mkString(",")
  }
}
